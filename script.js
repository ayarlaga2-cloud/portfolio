document.addEventListener('DOMContentLoaded', () => {
    ...
    const cgpaData = [
        ...
        { semester: 8, sgpa: null, cgpa: null }
    ];
    ...
    function renderHome() {
        return `
        <div class="relative min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center text-center px-4 overflow-hidden mesh-bg">
            <!-- Decorative blobs -->
            ...
            <!-- Avatar -->
            <div class="relative mb-8 animate-fade-in-up delay-100">
                ...
                <div class="relative w-28 h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-tr from-indigo-600 to-cyan-500 flex items-center justify-center text-white text-5xl font-bold shadow-2xl animate-float">AY</div>
            </div>

            <p class="text-indigo-600 font-semibold tracking-widest text-sm uppercase mb-3 animate-fade-in-up delay-200">Hello, I'm</p>

            <h1 class="text-5xl md:text-7xl lg:text-8xl font-extrabold text-gray-900 mb-4 tracking-tight animate-fade-in-up delay-300 text-balance">
                Abhiram <span class="gradient-text">Yarlagadda</span>
            </h1>

            <p id="tagline" class="text-xl md:text-2xl text-gray-600 mb-2 h-9 transition-opacity duration-500 animate-fade-in-up delay-500"></p>
            <p class="text-gray-500 max-w-2xl mb-10 animate-fade-in-up delay-700 px-4">
                B.Tech CSE (Data Science) at GITAM University · Building intelligent automation with LLMs, ML & full-stack systems.
            </p>

            <!-- Social row -->
            <div class="flex flex-wrap justify-center gap-3 mb-10 animate-fade-in-up delay-700">
                <a href="${personal.linkedin}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm hover:shadow-md text-gray-700 hover:text-indigo-600 transition-all hover:-translate-y-0.5 border border-gray-100">
                    ${icons.LinkedIn}<span class="text-sm font-medium">LinkedIn</span>
                </a>
                <a href="${personal.github}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm hover:shadow-md text-gray-700 hover:text-indigo-600 transition-all hover:-translate-y-0.5 border border-gray-100">
                    ${icons.Github}<span class="text-sm font-medium">GitHub</span>
                </a>
                <a href="mailto:${personal.email}" class="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm hover:shadow-md text-gray-700 hover:text-indigo-600 transition-all hover:-translate-y-0.5 border border-gray-100">
                    ${icons.Mail}<span class="text-sm font-medium">Email</span>
                </a>
            </div>
            ...
            <!-- Stat strip -->
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 max-w-4xl w-full animate-fade-in-up delay-1000">
                ${[
                    { num: '8.92', label: 'Current CGPA', color: 'from-indigo-600 to-cyan-500' },
                    ...
                    <div class="glass-card rounded-2xl p-5 text-center">
                        <div class="text-3xl md:text-4xl font-bold bg-gradient-to-r ${s.color} bg-clip-text text-transparent">${s.num}</div>
                        <div class="text-xs md:text-sm text-gray-600 font-medium mt-1">${s.label}</div>
                    </div>
                `).join('')}
            </div>
        </div>
    ...
    const renderCertifications = () => {
        const colorMap = {
            ...
            pink:   { from: 'from-emerald-500', to: 'to-teal-500',   text: 'text-emerald-600',   bg: 'bg-emerald-50' }
        };
